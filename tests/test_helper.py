...
class TestHelper(unittest.TestCase):
    ...
    def test_update_tweetcount_to_one(self):
        log = logging.getLogger('TestHelper.test_update_tweetcount_to_one')
    ...
    def test_update_tweetcount_to_two(self):
        log = logging.getLogger('TestHelper.test_update_tweetcount_to_two')
        self.ytdict.update_tc('a')
        self.ytdict.update_tc('a')
        get = self.ytdict['a'][2]
        expect = 2
    ...
    def test_set_videocount(self):
        log = logging.getLogger('TestHelper.test_set_videocount')
    ...
    def test_set_sharecount(self):
        log = logging.getLogger('TestHelper.test_set_sharecount')
