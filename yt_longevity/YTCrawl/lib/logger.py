...
class Logger(object):
    ...
    def __init__(self, outputDir=""):
        ...
        self._result_file = open(self._output_dir + '/key_result.txt', 'a+')
        self._log_file_dict = {'log' : open(self._output_dir + '/log.txt', 'a+')}

        #self._mutex_done = threading.Lock()
        #self._mutex_log = threading.Lock()

        self._done_file = open(self._output_dir + '/key_done.txt', 'a+')
    ...
    def add_log(self, d):
        ...
        for i, j in d.iteritems():
            self._log_file_dict[i] = open(self._output_dir + '/' + j + '.txt', 'a+')
