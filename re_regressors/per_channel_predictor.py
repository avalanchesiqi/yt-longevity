...
"""Predict relative engagement from channel specific predictor, with ridge regression.
            ...
            if f in train_channel_cnt_map and train_channel_cnt_map[f] >= k:
                ...
                with open(train_data_path, 'r') as fin:
                    for line in fin:
                        ...
                        vid, publish, duration, definition, category, detect_lang, channel, topics, _, _, _, re30, _ = line.rstrip().split('\t', 12)
