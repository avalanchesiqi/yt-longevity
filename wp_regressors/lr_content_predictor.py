...
if __name__ == '__main__':
        ...
        for f in files:
            with open(os.path.join(subdir, f), 'r') as fin:
                ...
                for line in fin:
                    ...
                    _, publish, duration, definition, category, detect_lang, _, _, _, _, _, wp30, _, _ = line.rstrip().split('\t', 13)
    ...
    print('>>> Predict watch percentage on content with ridge regressor...')
