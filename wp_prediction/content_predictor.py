...
def random_forest(train_x, train_y, test_x, test_y):
    ...
    print('>>> MAE on test set: {0:.4f}'.format(mean_absolute_error(test_y, test_yhat)))
    print('>>> R2 on test set: {0:.4f}'.format(r2_score(test_y, test_yhat)))
    print('=' * 79)
...
if __name__ == '__main__':
    ...
    predict_re = random_forest(train_df[cols], train_df[target], test_df[cols], test_df[target])
    ...
    if to_write:
        ...
        output_path = './output/content_predictor.p'
